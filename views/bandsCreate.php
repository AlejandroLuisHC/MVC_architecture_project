...
<head>
    ...
    <!-- JS -->
    <script src="../assets/js/bands.js" defer></script>
</head>
<body>
    ...
    <div class="container-fluid">
        <form class="mb-3 container justify-content-center" action="" method="POST" name="new" autocomplete="off">
            <fieldset>
                ...
                <div class="mb-3 col-6 container justify-content-center">
                    <label class="form-label" for="band_style">Band style:</label>
                    <select class="form-select" name="band_style">
