                        ...
                        <tbody id = "tBody">
                            <?php 
                                ...
                                foreach ($data['album'] as $d) {
                                    echo "<tr>";
                                    echo "<td><input class='form-control' type='number'  name='band_id' value='" . $d['album_id'] . "' readonly></td>";
                                    echo "<td><input class='form-control' type='text'  name='album_name' value='" . $d['album_name'] . "' ></td>";
                                    echo "<td><input class='form-control' type='number' min='1800' max='2023' name='album_year' value='" . $d['album_year'] . "' ></td>"; 
